...
The id and password for admin login is (id=Lelum) and (password=2023Keshma), however you can change it by running the command ( python manage.py createsuperuser  )
